...
void inst()
{
    ...
    cout << endl
         << "# Your password must be 8-20 characters long." << endl;
    cout << endl
         << "# You have to enter Filepath and Filename in different lines" << endl;
...
// {
//     wchar_t buff[MAX_PATH]; // Use wchar_t for wide characters
//     GetModuleFileNameW(NULL, buff, MAX_PATH);
//     std::wstring::size_type position = std::wstring(buff).find_last_of(L"\\/");
//     return std::wstring(buff).substr(0, position);
// }
...
int main()
{
    ...
    do
    {
        ...
        if (n == 1)
        {
            ...
            // std::wstring currentDirW = getCurrentDir();
            // std::string currentDir(currentDirW.begin(), currentDirW.end());
